...
export class World3D extends World3DCore {
  ...
  private buildHQInterior(cx: number, cz: number) {
    ...
    // Counter / checkout, located away from K Blanco's mission standing point.
    ...
    // Apparel racks and folded-product tables.
    ...
    // Back-wall brand mark: black panel, green arch line, gold KLOTHING bar.
    ...
    // Lounge/drop-table zone near the mission conversation.
